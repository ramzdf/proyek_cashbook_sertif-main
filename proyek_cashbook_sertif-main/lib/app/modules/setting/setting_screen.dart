...
class SettingScreen extends GetView<SettingController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: AppColor.contentColorBlack,
          ...
          children: [
            ...
            const Column(
              ...
              children: [
                ...
                Text("Nama\t\t\t\t: Mohamad Zidfi Rohmatu r"),
                Text("NIM\t\t\t\t\t\t\t: 2141764114"),
                Text("Tanggal\t: 20 September 2023"),
              ],
            )
          ],
        ),
                ...
                () => Container(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      elevation: 0,
                      primary: Color.fromARGB(255, 179, 178, 178),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 18),
                    elevation: 0,
                    primary: AppColor.contentColorBlack,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
                    ),
                  ),
